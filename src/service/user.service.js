const { getAllUsersDB, getUserByIdDB, createUsersDB, updateUsersDB } = require('../repository/user.repository')
...
module.exports = { getAllUsers, getUserById, createUsers, updateUsers }